#SFarris SpaceX App Assignment
#2024
#IBM Skills Network Labs

#####Set up environment in shell:####

#python3.11 -m pip install pandas dash    ##Installs dash

#Download dataset:#
#wget "https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/IBM-DS0321EN-SkillsNetwork/datasets/spacex_launch_dash.csv"

#Download skeleton Dash app to be completed:#
#wget "https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/IBM-DS0321EN-SkillsNetwork/labs/module_3/spacex_dash_app.py"

#Test the skeleton app by running the following:#
#python3.11 spacex_dash_app.py



#run this to begin coding with python in CloudIDE:#
#python3
...
def scatter(entered_site,payload):
    ...
    # thought reusing filtered_df may cause issues, but tried it out of curiosity and it seems
    #to be working fine
    ...
    if entered_site=='ALL':
        ...
        y='class',color='Booster Version Category',title=f"Success count on Payload mass for site {entered_site}")
        return fig
